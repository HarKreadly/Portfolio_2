...
const faqs = [
  {
    ...
    answer:
      "We provide high-quality digital solutions tailored to modern business needs, focusing on scalability and performance. Our team ensures that every line of code contributes to your business growth.",
  },
  {
    question: "How does the pricing work?",
    answer:
      "Our pricing is flexible and depends on the scope of the project. We also offer custom plans for enterprises, including dedicated support and infrastructure scaling.",
  },
  {
    question: "Can I cancel anytime?",
    answer:
      "Yes, you can cancel your subscription at any time without hidden fees or penalties. Your access will remain active until the end of the current billing cycle.",
  },
  {
    question: "Do you offer support?",
    answer:
      "Yes, we provide 24/7 customer support to ensure smooth operation of all services. You can reach us via email, live chat, or our dedicated phone line.",
  },
];
    ...
    >
      <div className="flex items-center justify-between w-full">
        <div className="flex items-center gap-5">
          ...
          <span
            className={`text-left font-bold tracking-tight transition-colors duration-300 ${isOpen ? "text-stone-900 dark:text-white text-lg" : "text-stone-600 dark:text-stone-400 text-base"}`}
          >
            {faq.question}
          </span>
        </div>
        <div
          className={`flex items-center justify-center w-9 h-9 rounded-full bg-white dark:bg-stone-800 shadow-sm shrink-0 transition-all duration-500 ${isOpen ? "rotate-90" : ""}`}
        >
          {isOpen ? (
...
const FAQSection = () => {
  ...
  return (
    <div
      ref={containerRef}
      style={{ height: `${faqs.length * 100}vh` }}
          ...
          <div className="w-full lg:w-[35%] flex flex-col">
            ...
            <h2 className="text-5xl md:text-7xl font-black font-sans leading-[0.9] tracking-tighter text-stone-900 dark:text-white mb-8">
              ...
              <span
                ...
                style={{ WebkitTextStroke: "1px #a8a29e" }}
              >
                QUERIES
              </span>
            </h2>
            ...
            <p className="text-stone-400 dark:text-stone-500 text-xs leading-loose max-w-sm mb-12">
              Our support framework is structured to provide clarity on our
              pedagogical approach and digital workflows. Scroll through to
              explore the most frequent questions from our partners.
            </p>
            ...
            <div className="flex flex-col w-full relative">
              ...
              <div className="absolute -left-12 top-0 bottom-0 w-px bg-stone-200 dark:bg-stone-800 hidden lg:block">
                <motion.div
                  ...
                  style={{
                    height: `${((currentIndex + 1) / faqs.length) * 100}%`,
                  }}
                />
              </div>
            </div>
