...
import SkillShowcase from "../components/features/Skills/SkillShowcase";
    ...
    cards: [
      {
        title: "React",
        icon: FaReact,
        desc: "Building modular, component-driven UIs with hooks, context, and optimised re-render patterns.",
      },
      {
        title: "GSAP",
        icon: SiJavascript,
        desc: "Award-winning motion design — scroll-triggered timelines, morphing SVGs, and physics springs.",
      },
      {
        title: "TypeScript",
        icon: SiTypescript,
        desc: "End-to-end type safety across large codebases: generics, discriminated unions, strict null checks.",
      },
      {
        title: "Figma",
        icon: FaFigma,
        desc: "Prototyping pixel-perfect designs and translating design tokens directly into production code.",
      },
      {
        title: "Redux",
        icon: SiRedux,
        desc: "Predictable global state management with RTK slices, selectors, and middleware pipelines.",
      },
      {
        title: "Webpack",
        icon: SiWebpack,
        desc: "Custom bundler config: code splitting, tree shaking, module federation, and build-time optimisations.",
      },
      {
        title: "CSS / SCSS",
        icon: Palette,
        desc: "Advanced layouts — CSS Grid, custom properties, animations, and BEM-structured stylesheets.",
      },
      {
        title: "Accessibility",
        icon: Globe,
        desc: "WCAG 2.1 AA compliance, semantic HTML, ARIA roles, keyboard navigation, and screen-reader support.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        title: "Node.js",
        icon: FaNodeJs,
        desc: "Event-driven, non-blocking server architecture — microservices, streaming, and worker threads.",
      },
      {
        title: "Express",
        icon: SiExpress,
        desc: "Minimal HTTP framework: middleware chains, routing, error handling, and JWT auth flows.",
      },
      {
        title: "MongoDB",
        icon: SiMongodb,
        desc: "Schema-flexible document storage with aggregation pipelines, indexing, and Atlas cloud hosting.",
      },
      {
        title: "PostgreSQL",
        icon: SiPostgresql,
        desc: "ACID-compliant relational queries, stored procedures, full-text search, and connection pooling.",
      },
      {
        title: "GraphQL",
        icon: Layers,
        desc: "Declarative data fetching with Apollo Server, dataloaders, and subscriptions over WebSockets.",
      },
      {
        title: "REST APIs",
        icon: Globe,
        desc: "RESTful design principles — versioning, hypermedia, rate limiting, and OpenAPI documentation.",
      },
      {
        title: "Auth",
        icon: Cpu,
        desc: "OAuth 2.0, JWT, session management, RBAC, and secure refresh-token rotation strategies.",
      },
      {
        title: "SQL",
        icon: Database,
        desc: "Complex relational modelling: joins, window functions, CTEs, and query-plan optimisation.",
      },
    ],
  },
  {
    ...
    cards: [
      {
        title: "Git",
        icon: FaGitAlt,
        desc: "Branch strategies (Git Flow, trunk-based), interactive rebasing, bisect, and large-repo tooling.",
      },
      {
        title: "Docker",
        icon: FaDocker,
        desc: "Multi-stage image builds, compose orchestration, layer caching, and secure runtime configs.",
      },
      {
        title: "AWS",
        icon: FaAws,
        desc: "S3, Lambda, EC2, CloudFront, RDS — architecting serverless and containerised cloud solutions.",
      },
      {
        title: "CI / CD",
        icon: Layers,
        desc: "GitHub Actions and GitLab pipelines: lint, test, build, deploy — zero-downtime blue-green releases.",
      },
      {
        title: "Jest",
        icon: SiJest,
        desc: "Unit and integration testing — mocking, snapshot tests, coverage thresholds, and TDD workflows.",
      },
      {
        title: "Webpack",
        icon: SiWebpack,
        desc: "Bundle analysis, performance budgets, dynamic imports, and micro-frontend configurations.",
      },
      {
        title: "Performance",
        icon: TrendingUp,
        desc: "Core Web Vitals optimisation, lazy loading, virtual lists, memoisation, and profiling tools.",
      },
      {
        title: "Reliability",
        icon: Wrench,
        desc: "Error boundaries, Sentry integration, structured logging, alerting, and chaos-engineering drills.",
      },
    ],
  },
  {
    ...
    image: img4,
    description:
      "Defining the visual language and user psychology that transforms digital products into memorable, brand-defining experiences.",
    cards: [
      {
        title: "UI Design",
        icon: Palette,
        desc: "Crafting intuitive interfaces with emphasis on visual hierarchy and user-centric flows.",
      },
      {
        title: "Brand Art",
        icon: Cpu,
        desc: "Developing cohesive visual identities: logos, palettes, and brand guidelines.",
      },
      {
        title: "Motion",
        icon: TrendingUp,
        desc: "Animating micro-interactions and transitions to enhance spatial awareness.",
      },
      {
        title: "Typography",
        icon: Globe,
        desc: "Precise typesetting and font pairing to ensure readability and tone across platforms.",
      },
      {
        title: "Prototyping",
        icon: Layers,
        desc: "Rapidly iterating interactive mockups to validate UX concepts early in development.",
      },
      {
        title: "UX Research",
        icon: Database,
        desc: "Analysing user behavior and feedback to drive data-informed design decisions.",
      },
      {
        title: "Illustration",
        icon: Palette,
        desc: "Creating custom vector assets and icons to give products a unique visual voice.",
      },
      {
        title: "Design Sys",
        icon: Wrench,
        desc: "Building scalable atomic design libraries for consistent multi-platform delivery.",
      },
    ],
  },
  {
    ...
    image: imgOther,
    description:
      "Fostering technical excellence through cross-functional team management, agile mentorship, and continuous technological research.",
    cards: [
      {
        title: "Management",
        icon: Layers,
        desc: "Leading cross-functional teams to deliver complex software on strict deadlines.",
      },
      {
        title: "Agile",
        icon: TrendingUp,
        desc: "Scrum and Kanban mastery: sprint planning, retrospectives, and backlog grooming.",
      },
      {
        title: "Mentoring",
        icon: Cpu,
        desc: "Guiding junior developers through code reviews and pair programming sessions.",
      },
      {
        title: "Open Source",
        icon: Globe,
        desc: "Contributing to community projects and maintaining public library ecosystems.",
      },
      {
        title: "Research",
        icon: Database,
        desc: "Staying ahead of trends by investigating emerging technologies and paradigms.",
      },
      {
        title: "Soft Skills",
        icon: TrendingUp,
        desc: "Optimising team velocity through effective communication and conflict resolution.",
      },
      {
        title: "Documentation",
        icon: Wrench,
        desc: "Writing clear, comprehensive technical guides for both internal and public APIs.",
      },
      {
        title: "Community",
        icon: Globe,
        desc: "Active participation in tech meetups, forums, and knowledge-sharing initiatives.",
      },
    ],
  },
];
          ...
          <div className="w-12 md:w-14 bg-zinc-800 dark:bg-zinc-200 flex flex-col items-center py-8 relative z-40 h-full">
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-20">
              {SIDEBAR_CATEGORIES.map((label, i) => {
                const isActive =
                  i === CHAPTERS[Math.round(activeChapter)]?.sidebarIndex;
